    ...
    <header class="masthead text-white text-center" style="height: 100%;">
        <div class="container">
            <div class="row">
    ...
    youtubeconvert: function(link){
        ...
        function(data){
         ...
         if(aa['error'] != null){
            ...
            html='<div class="col-md-6 float-left"><img src="'+aa['thumbnail_url']+'" id="res_thumbnail"></div>';
            
            html+='<div class="col-md-6 float-right res_button"><div class="row"><div class="col-md-6"><a href="https://api.flvto.tv/mp3.html#'+aa['id']+'" target="_blank"><button class="btn btn-warning border rounded" type="button" id="download-btn">Server 2</button></a>';
             
            html+=' </div><div class="col-md-6"></div><div class="col-md-6"><a href="'+aa['download']['data']['html']+'" target="_blank"><button class="btn btn-success border rounded" type="button" id="download-btn">Server 1</button></a><br></div>';


            html+='<div class="col-md-6"></div><div class="col-md-6" ><span class="badge badge-primary">By: '+aa['author_name']+'</span></div><div class="col-md-6"></div><div class="col-md-6"><span class="badge badge-warning" id="res_info"><h4>'+aa['title']+'</h4></span></div> </div></div>';
